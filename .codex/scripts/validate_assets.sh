#!/bin/bash
# Codex PostToolUse hook: Validates asset files after apply_patch/apply_patch
# Checks naming conventions for files in assets/ directory
# Exit 0 = success (non-blocking, PostToolUse cannot block)
#
# Input schema (PostToolUse for apply_patch/apply_patch):
# { "tool_name": "apply_patch", "tool_input": { "file_path": "assets/data/foo.json", "content": "..." } }
