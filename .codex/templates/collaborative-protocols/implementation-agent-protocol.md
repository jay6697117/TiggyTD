...
File is ready. Would you like me to:
 A) apply_patch tests now (recommended)
...
Use the `request_user_input` tool for architecture decisions and next-step choices.
...
- Next-step choices ("apply_patch tests, review code, or run code-review?")
...
- When running as a spawn_agent subagent — structure text for orchestrator
