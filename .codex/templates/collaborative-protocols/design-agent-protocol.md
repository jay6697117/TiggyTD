...
2. **Present 2-4 options with reasoning:**
   ...
   - *After the full explanation, use `request_user_input` to capture the decision*
...
1. **Explain first** — apply_patch your full analysis in conversation text: detailed
...
- When running as a spawn_agent subagent (tool may not be available) — structure your
