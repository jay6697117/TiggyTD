...
| ID | spawn_agent | Agent/Owner | Est. Days | Dependencies | Acceptance Criteria | Status |
|----|------|-------------|-----------|-------------|-------------------|--------|
...
| Original ID | spawn_agent | Reason for Carryover | New Estimate | Priority Change |
|------------|------|---------------------|-------------|----------------|
...
| Day | spawn_agents Completed | spawn_agents In Progress | Blockers | Notes |
|-----|----------------|------------------|----------|-------|
| Day 1 | | | | |
| Day 2 | | | | |
| Day 3 | | | | |
