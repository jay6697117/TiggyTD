...
1. **[spawn_agent 1]**: [e.g., "Create full design doc for this system"]
2. **[spawn_agent 2]**: [e.g., "apply_patch ADR for technical approach"]
3. **[spawn_agent 3]**: [e.g., "Add to backlog for Sprint X"]

### Before Production (If Needs More Work)
1. **[spawn_agent 1]**: [e.g., "Build second prototype testing X variation"]
2. **[spawn_agent 2]**: [e.g., "Playtest with 5+ people"]
3. **[spawn_agent 3]**: [e.g., "Investigate technical feasibility of Y"]

### If Abandoning
1. **[spawn_agent 1]**: [e.g., "Archive prototype with this document"]
2. **[spawn_agent 2]**: [e.g., "Extract reusable code/learnings"]
3. **[spawn_agent 3]**: [e.g., "Update game pillars if this changed thinking"]
