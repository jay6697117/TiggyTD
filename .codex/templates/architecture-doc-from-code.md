...
**Immediate**:
- [ ] [spawn_agent 1 — e.g., "Add missing unit tests"]
- [ ] [spawn_agent 2 — e.g., "Document edge case handling"]

**Short-Term**:
- [ ] [spawn_agent 3 — e.g., "Refactor X for clarity"]
- [ ] [spawn_agent 4 — e.g., "Add performance monitoring"]

**Long-Term**:
- [ ] [spawn_agent 5 — e.g., "Revisit decision when Y is available"]
