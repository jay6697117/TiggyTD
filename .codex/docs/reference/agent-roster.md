...
`.codex/docs/roles/`. Use the agent best suited to the task at hand. When a task
...
| `tools-programmer` | Dev tools | Sonnet | apply_patchor extensions, pipeline tools, debug utilities |
