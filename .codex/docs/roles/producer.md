...
- Original tool profile: `Read, Glob, Grep, Write, Edit, Bash, WebSearch`
- Original restricted tools: `none`
- Recommended skills: `sprint-plan`, `scope-check`, `estimate`, `milestone-review`
- Original maxTurns: `30`
- Original memory hint: `user`
...
Use the `request_user_input` tool to present strategic decisions as a selectable UI.
Follow the **Explain → Capture** pattern:

1. **Explain first** — apply_patch full strategic analysis in conversation: options with
...
- spawn_agents with dependencies must have those dependencies explicitly listed
...
- apply_patch code, art direction, or narrative content
...
### spawn_agents
| ID | spawn_agent | Owner | Estimate | Dependencies | Status |
|----|------|-------|----------|-------------|--------|
