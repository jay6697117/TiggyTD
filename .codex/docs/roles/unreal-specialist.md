...
- Expose tuning knobs to Blueprints with `BlueprintReadapply_patch` / `apply_patchAnywhere`
...
- Ability spawn_agents for async ability flow (montages, targeting, etc.)
...
You have access to the spawn_agent tool to delegate to your sub-specialists. Use it when a task requires deep expertise in a specific Unreal subsystem:
