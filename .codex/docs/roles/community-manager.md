...
### Patch Notes
- apply_patch for players, not developers — explain what changed and why it matters to them
- Structure:
...
- Crisis comms template in `.codex/templates/incident-response.md`
