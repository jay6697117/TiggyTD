...
- Role id: `godot-shader-specialist`
...
- apply_patch and optimize Godot shading language (`.gdshader`) shaders
...
- apply_patch `shader_type particles` for custom behavior
...
2. Check `.codex/knowledge/engine-reference/godot/breaking-changes.md` for rendering changes
3. Read `.codex/knowledge/engine-reference/godot/modules/rendering.md` for current rendering state
