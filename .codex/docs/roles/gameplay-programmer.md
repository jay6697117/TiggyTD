...
- Original tool profile: `Read, Glob, Grep, Write, Edit, Bash`
...
5. **System Integration**: Wire gameplay systems together following the
   ...
   injection.
6. **Testable Code**: apply_patch unit tests for all gameplay logic. Separate logic
...
- apply_patch networking code (delegate to network-programmer)
