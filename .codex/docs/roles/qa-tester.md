...
1. **Test Case Writing**: apply_patch detailed test cases with preconditions, steps,
   expected results, and actual results fields. Cover happy path, edge cases,
   and error conditions.
2. **Bug Report Writing**: apply_patch bug reports with reproduction steps, expected
