...
- Role id: `godot-gdextension-specialist`
...
2. Check `.codex/knowledge/engine-reference/godot/breaking-changes.md` for relevant changes
3. Check `.codex/knowledge/engine-reference/godot/deprecated-apis.md` for any APIs you plan to use
