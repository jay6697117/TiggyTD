...
- Role id: `godot-gdscript-specialist`
...
- apply_patchor signal connections (invisible in code, hard to track)
...
4. Read `.codex/knowledge/engine-reference/godot/current-best-practices.md` for new GDScript features
