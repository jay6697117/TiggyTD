...
- Original tool profile: `Read, Glob, Grep, Write, Edit, Bash, Task`
- Original restricted tools: `none`
...
- Document every autoload's purpose in .codex/docs/project-instructions.md
...
You have access to the spawn_agent tool to delegate to your sub-specialists. Use it when a task requires deep expertise in a specific Godot subsystem:
...
1. Read `.codex/knowledge/engine-reference/godot/VERSION.md` to confirm the engine version
2. Check `.codex/knowledge/engine-reference/godot/deprecated-apis.md` for any APIs you plan to use
3. Check `.codex/knowledge/engine-reference/godot/breaking-changes.md` for relevant version transitions
4. For subsystem-specific work, read the relevant `.codex/knowledge/engine-reference/godot/modules/*.md`
