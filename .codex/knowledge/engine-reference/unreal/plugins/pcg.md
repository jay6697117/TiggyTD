...
### 1. **PCG Graph**
- Node-based graph (similar to Material apply_patchor)
...
`apply_patch > Plugins > PCG > Enabled > Restart`
...
2. Open PCG Graph apply_patchor
...
- PCG Graph apply_patchor > Debug > Show Debug Points
