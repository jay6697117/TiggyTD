...
- Modular node graph (similar to Material apply_patchor)
...
`apply_patch > Plugins > Gameplay Cameras > Enabled > Restart`
...
2. Open Camera Rig apply_patchor (node-based graph)
...
```cpp
UPROPERTY(apply_patchAnywhere, Category = "Camera")
