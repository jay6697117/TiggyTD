...
1. **Enable Plugin**: `apply_patch > Plugins > Enhanced Input` (enabled by default in UE5)
...
public:
    ...
    UPROPERTY(apply_patchAnywhere, BlueprintReadOnly, Category = "Input")
...
```cpp
// Define contexts
UPROPERTY(apply_patchAnywhere, Category = "Input")
