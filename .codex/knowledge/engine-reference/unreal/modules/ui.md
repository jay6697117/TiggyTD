...
UPROPERTY(apply_patchAnywhere, Category = "UI")
...
### apply_patchableTextBox (Input Field)

```cpp
UPROPERTY(meta = (BindWidget))
TObjectPtr<Uapply_patchableTextBox> PlayerNameInput;
...
```cpp
// Enable: apply_patch > Plugins > CommonUI
// Restart editor
```
