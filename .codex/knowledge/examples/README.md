...
4. **Agents Get Approval Before Writing Files**
   - Explicit "May I write to [file]?" before using apply_patch/apply_patch tools
...
> "Please follow the collaborative protocol from .codex/docs/reference/COLLABORATIVE-DESIGN-PRINCIPLE.md"

---

## 📝 **Additional Resources**

- **Full Principle Documentation:** [.codex/docs/reference/COLLABORATIVE-DESIGN-PRINCIPLE.md](../COLLABORATIVE-DESIGN-PRINCIPLE.md)
- **Workflow Guide:** [.codex/docs/reference/WORKFLOW-GUIDE.md](../WORKFLOW-GUIDE.md)
- **Agent Roster:** [.codex/docs/reference/agent-roster.md](../../.codex/docs/reference/agent-roster.md)
- **.codex/docs/project-instructions.md (Collaboration Protocol):** [.codex/docs/project-instructions.md](../../.codex/docs/project-instructions.md#collaboration-protocol)
