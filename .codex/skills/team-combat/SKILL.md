...
Arguments: `[combat feature description]`
...
- **qa-tester** — apply_patch test cases and validate the implementation
...
- `subagent_type: qa-tester` — apply_patch test cases and validate implementation
...
- apply_patch test cases from the acceptance criteria
