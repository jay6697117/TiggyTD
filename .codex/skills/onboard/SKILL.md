...
1. **Read the .codex/docs/project-instructions.md** for project overview and standards.

2. **Read the relevant agent definition** from `.codex/docs/roles/` if a specific
   role is specified.
...
[Summary of conventions relevant to this role from .codex/docs/project-instructions.md and agent definition]
