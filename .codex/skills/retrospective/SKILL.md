...
Arguments: `[sprint-N|milestone-name]`
...
4. **Scan for completed and incomplete tasks** by comparing the plan against
   ...
   - spawn_agents completed as planned
   - spawn_agents completed but modified from the plan
   - spawn_agents carried over (not completed)
   - spawn_agents added mid-sprint (unplanned work)
   - spawn_agents removed or descoped
...
| Bugs Found | -- | [N] | -- |
| Bugs Fixed | -- | [N] | -- |
| Unplanned spawn_agents Added | -- | [N] | -- |
| Commits | -- | [N] | -- |
...
| spawn_agent | Estimated | Actual | Variance | Likely Cause |
|------|-----------|--------|----------|--------------|
...
| spawn_agent | Original Sprint | Times Carried | Reason | Action |
|------|----------------|---------------|--------|--------|
| [spawn_agent that was not completed] | [Sprint N-X] | [N] | [Why] | [Complete / Descope / Redesign] |
