...
Arguments: `[engine version] or no args for guided selection`
...
## 4. Update .codex/docs/project-instructions.md Technology Stack

Read `.codex/docs/project-instructions.md` and update the Technology Stack section. Replace the
...
After updating .codex/docs/project-instructions.md, create or update `.codex/docs/reference/technical-preferences.md` with
...
Create a minimal `.codex/knowledge/engine-reference/<engine>/VERSION.md`:
...
3. **Create the full reference directory**:
   ```
   .codex/knowledge/engine-reference/<engine>/
...
## 8. Update .codex/docs/project-instructions.md Import
...
@.codex/knowledge/engine-reference/<engine>/VERSION.md
```
...
1. Read `.codex/knowledge/engine-reference/<engine>/VERSION.md`
...
1. Read the existing `.codex/knowledge/engine-reference/<engine>/VERSION.md` to get
...
.codex/docs/project-instructions.md:       [updated]
Tech Prefs:      [created/updated]
Agent Config:    [verified]

Next Steps:
1. Review .codex/knowledge/engine-reference/<engine>/VERSION.md
...
- Always show the user what you're about to change before making .codex/docs/project-instructions.md edits
