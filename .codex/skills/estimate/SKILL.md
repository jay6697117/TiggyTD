...
2. **Read .codex/docs/project-instructions.md** for project context: tech stack, coding standards,
...
```markdown
## spawn_agent Estimate: [spawn_agent Name]
Generated: [Date]
...
| Similar spawn_agent | Estimated | Actual | Relevant Difference |
|-------------|-----------|--------|-------------------|
