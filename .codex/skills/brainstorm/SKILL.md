...
Arguments: `[genre or theme hint, or 'open' for fully open brainstorm]`
...
3. **Run through ideation phases** interactively, asking the user questions at
   ...
   **Use `request_user_input`** at key decision points throughout brainstorming:
   ...
   apply_patch full creative analysis in conversation text first, then use
...
4. **Generate the game concept document** using the template at
   `.codex/templates/game-concept.md`. Fill in ALL sections from the
